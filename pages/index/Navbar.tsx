        ...
        >
            ...
            <div className={`${hidden} w-full lg:flex md:items-center md:w-auto`} id="menu">
              ...
              md:pt-0"
                >
                    <li>
                        <a className="md:p-4 py-2 block text-center hover:text-purple-400" href="#">Features</a>
                    </li>
                    <li>
                        <a className="md:p-4 py-2 block text-center hover:text-purple-400" href="#">Common Uses</a>
                    </li>
                    <li>
                        <a className="md:p-4 py-2 block text-center hover:text-purple-400" href="#">For Teams</a>
                    </li>
                    <li>
            ...
            <svg
                ...
                id="menu-button"
                className="h-6 w-6 justify-center text-center cursor-pointer lg:hidden block"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
